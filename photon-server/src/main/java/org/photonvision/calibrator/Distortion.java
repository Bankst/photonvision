    ...
    private static Rect get_bounds(Mat thresh, Mat mask) {
        ...
        while (contours.size() > 0) {
            ...
            for (int i = 0; i < contours.size(); i++) {
                ...
                // Main.LOGGER.log(Level.WARNING, "Contour " + (mx+1) + " of " + contours.size() + ", area
                // max so far " + areaContourMax
            ...
            // Main.LOGGER.log(Level.WARNING, "returning aabb " + aabb); // best contributing contour for
            // the pose
